                                ...
                                <div class="portlet-content">						
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table 
                                            ...
                                            <tbody>
                                                <?php
                                                $midwife = DB::getInstance()->query("SELECT co.*,ce.*,cs.*,cp.* FROM core_encounter ce,core_observer co,core_subject cs,core_patients cp where ce.uuid=co.uuid and cs.uuid=co.uuid and cs.id=cp.subject_ptr_id and co.role='midwife'");
