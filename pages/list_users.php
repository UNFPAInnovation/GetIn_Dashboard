                                        ...
                                        <table 
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-filterable="true" class="hidden-xs hidden-sm">Website</th>
                                                    <th data-filterable="true" class="hidden-xs hidden-sm">Role</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $users_list = DB::getInstance()->query("SELECT * FROM jerm_users");
                                                foreach ($users_list->results() as $users_list) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="hidden-xs hidden-sm"><?php echo $users_list->Website;  ?></td>
